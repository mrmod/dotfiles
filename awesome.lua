...
-- Fullscreen youtube will stay in a window. Doesn't respond to window arrangements
...
mytextclock = wibox.widget.textclock("%m/%d %A %I:%M %p")
...
globalkeys = gears.table.join(
    ...
    awful.key({modkey,"Shift"}, "Up", function() awful.tag.incmwfact(0.01) end),
    awful.key({modkey,"Shift"}, "Down", function() awful.tag.incmwfact(-0.01) end),
